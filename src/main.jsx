...
import AddProduto from './routes/AddProduto.jsx'; // Importe o componente de adição de produtos
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: '/adicionar/produto', element: <AddProduto /> }, // Rota para adicionar produtos
    ],
  },
]);
